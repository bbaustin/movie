                ...
                var promise = new Promise(function(resolve, reject) {
                  ...
                  request(pageToVisit, function(error, response, body) {
                    ...
                    if(response.statusCode === 200) {
                      ...
                      callback(null, tsutayaTitle);
                    }
                  })
                  return tsutayaTitle;
                })
              } //makeTitleforURL
              makeTitleForURL(req.body.movieTitle);
            }
        }, function(err, results) {
          res.render('home', { error: err, message: results.themoviedb, message2: results.tsutaya});
        });
    })
